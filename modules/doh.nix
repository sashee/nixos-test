...
{
  options.common.doh.enable = lib.mkOption {
    type = lib.types.bool;
    default = true;
    description = "Enable system-wide DNS over HTTPS and block direct plaintext DNS egress.";
  };

  config = lib.mkIf config.common.doh.enable {
